<%@ Page Title="Services" Language="C#" MasterPageFile="~/User/Usermaster.Master" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="EBusBookingSystem.User.WebForm4" %>
				...
				<div class="col-md-4 agileits_service_grid_btm_left">
					<div class="agileits_service_grid_btm_left1">
						<div class="agileits_service_grid_btm_left2">
							<h5>Deal 1</h5>
							<p>Per day<span>RPS</span>3300.00</p>
